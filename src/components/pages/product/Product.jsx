            ...
            <div className='container mx-auto'>
                <div className='pt-7'>
                    ...
                    <div className='flex flex-wrap gap-8 justify-center'>
                        {
                            product.map((product) => (
                                <div key={product.id} className='flex flex-col items-center theme w-[300px] h-[400px] md:shadow-xl'>
                    ...
                    <div className='flex flex-col md:flex-row items-center mt-32 justify-center'>
                        <div>
                            <img src={watch} className=' w-[250px] md:w-[300px] mb-10' alt='watch pic '></img>
                        </div>
                        <div>
