      ...
      <div>
        {
          ...
          cart.line_items?.map((product) => (
            <div key={product.id} className='flex themee theme  md:h-[200px] w-[370px] md:w-[500px] m-5 shadow-md'>
              <div>
                <img src={product.image.url} alt='cart product' className='md:w-[200px] md:h-[200px] bg-white object-cover object-center ' ></img>
              </div>
              <div className='flex flex-col   justify-center space-y-7 w-[250px]'>

                <div className=' flex flex-col  md:items-start justify-center ml-7'>
    ...
    <div>
      ...
      <div className='clip h-[100vh] md:m-5'>
        <div className='container mx-auto'>
          <nav className='flex justify-between pt-7 px-10 md:px-0'>
          ...
          <div className='flex justify-center mt-40 md:mt-[350px]'>
            <div className='w-[370px] md:w-[800px] h-[200px]'>
              <h1 className='themee text-3xl md:text-5xl font-medium'>Your taste determines what you attract...  </h1>
            </div>
      ...
      <div className={`absolute w-[400px] md:w-[550px] h-[110vh] shadow-xl overflow-y-scroll scroll-smooth scroll-hidden themeee z-30 ${isOpen ? 'right-0' : 'right-[-700px]'} top-0 duration-300 `}>
